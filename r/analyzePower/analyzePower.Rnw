...
<<echo=FALSE,fig=TRUE>>=
o1=read.csv("data/power_tests/orienData_1454790270760.csv",comment.char = "#", colClasses = c(NA,NA,"NULL","NULL","NULL"))
berechnenull(o1)
@
\item Lagedaten und Beschleunigungsdaten 1x pro Sekunde aufgezeichnet
<<echo=FALSE,fig=TRUE>>=
o2=read.csv("data/power_tests/3/orienData_1454849524365.csv",comment.char = "#", colClasses = c(NA,NA,"NULL","NULL","NULL"))
berechnenull(o2)
@
